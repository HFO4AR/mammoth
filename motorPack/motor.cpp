...
void Motor::PosPidInit(float kp, float ki, float kd, float kaw, float max_output) {
    if (kaw == -1.0f) {
...
void Motor::SpdPidInit(float kp, float ki, float kd, float kaw, float max_output) {
    if (kaw == -1.0f) {
